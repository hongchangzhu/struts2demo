...
public class RedisDemo {
	...
	private Jedis init() {
		redis = new Jedis("172.20.192.11", 6379, 2000);
		try {
			// redis.auth("xtkingdee");
	...
	public void rHash() {
		...
		System.out.println("从hash中格局属性取值：" + redis.hget("hash", "username"));
	...
	public void test1() {
		...
		// rSet();
		// rString();
		System.out.println("foo=" + redis.exists("foo"));
	}
